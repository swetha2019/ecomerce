            ...
            <div class="panel-body">
              ...
              <div class="content-area">
               ...
               <div class="widget">
                                        ...
                                        <table class="prj-tbl bordered table-responsive">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span>{{$fetch->vendor_name}}</span></td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td><span>@if($fetch->verified==1) <div style="color: green"> Active @else <div style="color: red">  deactive </div> @endif</span></td>
                                                    <td>
                                                        <ul>
                                                            <li><a href="#" class="del-btn"><i class="icon-trash"></i></a></li>
                                                            <li><a href="#" class="edit-btn"><i class="icon-pencil"></i></a></li>
                                                        </ul>
                                                    </td>
                                                </tr>
                                                @endforeach
                                               <!-- <tr>
                                                    ...
                                                    <td><span>Map Pins &amp; Tooltips</span></td>
                                                    <td><i>11 January 2019</i></td>
                                                    <td>
                                                        <div class="prg-br">
                                                            <div class="progress">
                                                ...
                                                <tr>
                                                    <td><i class="sngl-slct"></i></td>
                                                    <td><span>Vector World Map</span></td>
                                                    <td><i>13 January 2019</i></td>
                                                    <td>
                                                        <div class="prg-br">
                                                            <div class="progress">
                                                ...
                                                <tr>
                                                    <td><i class="sngl-slct"></i></td>
                                                    <td><span>World map and info</span></td>
                                                    <td><i>15 January 2019</i></td>
                                                    <td>
                                                        <div class="prg-br">
                                                            <div class="progress">
