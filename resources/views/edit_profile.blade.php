                                        ...
                                        <ul class="parent-menu">
											...
											<li class="menu-item-has-children active"> <a title=""><i class="fa fa-inbox"></i><span>Pages</span></a>
                                                <ul class="mega" style="display: block;">
                                                    <li><a href="template/profile.html">profile</a></li>
                                                    <li><a class="active" href="template/edit-profile.html">edit profile</a></li>
				  ...
				  <form method="post" action="edit">
                    ...
                    <div class="pnl-bdy billing-sec">
                      ...
                      <div class="col-md-6 col-sm-6 field">
                        ...
                        <input value="<?php echo $user = Auth::user()->name;?>" type="text">
                      </div>
                      <div class="col-md-6 col-sm-6 field">
                      ...
                      <div class="col-md-12 col-sm-12 field">
                        ...
                        <input placeholder="" value="<?php echo $user = Auth::user()->Email;?>" type="text">
                      </div>
                      <div class="col-md-12 col-sm-12 field">
                      ...
                      <!-- <div class="col-md-6 col-sm-6 field">
                        ...
                        <input type="radio" name="female" value="female" checked>
                      </div> -->
